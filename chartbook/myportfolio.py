...
adj_sharpe = (perf.table.loc['Sharpe'] * (1/3)).multiply(sharpe_factor)
exp_ret = adj_sharpe * vols + rf

# generate correlation matrix
df_corr = df_eri.resample('M').last().pct_change(1).ewm(com=12).corr()
corr_mat = df_corr.xs('2022-04-30', level=0)
