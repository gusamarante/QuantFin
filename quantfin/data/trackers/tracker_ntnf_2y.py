...
for date, datem1 in tqdm(zip(dates2loop[1:], dates2loop[:-1]), 'Backtesting NTN-F 2y'):
...
df_bt.to_csv(DROPBOX.joinpath('trackers/ntnf_2y.csv'), sep=';')
minutes = round(time() - tic, 2)
print('NTNF 2y took', minutes, 'seconds')
