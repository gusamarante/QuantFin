...
for date, datem1 in tqdm(zip(dates2loop[1:], dates2loop[:-1]), 'Backtesting LTN Longa'):
...
df_bt.to_csv(DROPBOX.joinpath('trackers/ltn_longa.csv'), sep=';')
minutes = round((time() - tic) / 60, 2)
print('LTN Longa took', minutes, 'minutes')
