...
from quantfin.utils import Date

# Add some type annotations here: numpy stubs are being developed (
# https://github.com/numpy/numpy-stubs) and once ready we can improve this
DateArray = Union[Date, Iterable[Date], DatetimeIndex]
TsArray = Union[Timestamp, DatetimeIndex]
...
class DayCounts(object):
    ...
    def tf(self, d1: DateArray, d2: DateArray) -> Union[float, ndarray]:
    ...
    def days(self, d1: DateArray, d2: DateArray) -> Union[int, ndarray]:
    ...
    def adjust(self, d: DateArray) -> TsArray:
    ...
    def daysnodc(self, d1: DateArray, d2: DateArray) -> Union[int, ndarray]:
    ...
    def dib(self,
            d1: Optional[DateArray] = None,
            d2: Optional[DateArray] = None
    ...
    def bdy(self, d: DateArray) -> Union[int, ndarray]:
    ...
    def hasleap(self, d1: DateArray, d2: DateArray) -> Union[bool, ndarray]:
    ...
    def leapdays(self, d1: DateArray, d2: DateArray) -> Union[bool, ndarray]:
    ...
    def dy(self, d: DateArray) -> Union[int, ndarray]:
    ...
    def isleap(self, d: DateArray) -> Union[bool, ndarray]:
